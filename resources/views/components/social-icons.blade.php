<div {{ $attributes->merge(['class' => 'flex items-center']) }}>
    <a
        href="https://www.linkedin.com/in/tanja-radovic-jolic-46917431/"
        class="
        w-10 
        h-10 
        flex 
    ...
    <a
        href="https://www.facebook.com/tanja.radovicjolic/"
        target="_blank"
        class="
        w-10 
        h-10 
    ...
    <a
        href="https://www.instagram.com/tanja.radovic.jolic/"
        target="_blank"
        class="
        w-10
        h-10
